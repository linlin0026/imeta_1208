...
## Data source: fig6_A.csv
## Plot generated using Cytoscape

## (B) Daily abundance changes of CAG8 during the intervention period
## Data source: fig6_B.csv
## Plot generated using R

```{r, echo=FALSE, fig.width=10, fig.height=4}
group_color <-c("#CFB1D7", "#9378A3", "#B484C6", "#9042AC", "#9793C4", "#8683BD", "#786EB2", "#6C55A5", "#603E9A")

df <-  read.csv("fig6_B.csv",header = 1, check.names = F) %>%
  mutate(
...
## (C) Daily concentration changes of maleic acid during the intervention period
## Data source: fig6_C.csv
## Plot generated using R

```{r, echo=FALSE, fig.width=10, fig.height=4}
group_color <-c("#CFB1D7", "#9378A3", "#B484C6", "#9042AC", "#9793C4", "#8683BD", "#786EB2", "#6C55A5", "#603E9A")

df <-  read.csv("fig6_C.csv",header = 1, check.names = F) %>%
  mutate(
    group = as.factor(substr(ID, 1, 1)),
    day_number = as.numeric(gsub("D", "", Day0_27)),
    period = case_when(
...
## (D) Metabolic flow chart: Butanoate metabolism (KEGG pathway #00650)
## Data source: fig6_D.csv
## Plot generated using Adobe Illustrator

## (E) Network of relationships among HQMAGs within CAG8
## Data source: fig6_E.csv
## Plot generated using Cytoscape

## (F) Repeated-measures correlation between maleic acid and CGM metrics
## Data source: fig6_F.csv
## Plot generated using R
...
rmcorr_df <- read.csv("fig6_F.csv", header = TRUE, check.names = FALSE, row.names = 1)
